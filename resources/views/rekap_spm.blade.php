...
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Rekap Data Uji SPM</h3>
    </div>
	<div class="card shadow border-left-primary py-2">
        <div class="card-body">
            <a href="{{url('/rekap/spm/export/aktif')}}" class="btn btn-success"><i class="fas fa-database"></i> Rekap Data Kendaraan Uji SPM Aktif</a>
            <a href="{{url('/rekap/spm/export/nonaktif')}}" class="btn btn-danger"><i class="fas fa-database"></i> Rekap Data Kendaraan Uji SPM Nonaktif</a>
        </div>
	</div>
</div>
@endsection